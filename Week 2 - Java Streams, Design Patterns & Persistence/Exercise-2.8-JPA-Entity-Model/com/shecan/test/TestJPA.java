...
public class TestJPA {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Test 3: Optimistic Locking with OptimisticLockException
            ...
            try {
                ...
                // Session 2: Load the same product
                ...
                // Session 2: Try to update with old version - should throw OptimisticLockException!
                product2.setStock(5);
                System.out.println("\n  Session 2 trying to update stock to 5...");
                System.out.println("  Session 2 has version: " + product2.getVersion());

                try {
                    em2.flush(); // This should throw OptimisticLockException!
                    ...
                    System.out.println("     Version mismatch detected as expected!");
                }

                em1.getTransaction().commit();
                System.out.println("\n  Session 1 transaction committed successfully.");
            ...
            // Test 5: Category with @OneToMany
            ...
            System.out.println("  ✅ @Entity, @Id, @Column, @Version used");
            System.out.println("  ✅ @OneToMany mappedBy used");
            System.out.println("  ✅ Custom JPQL query implemented");
            System.out.println("  ✅ OptimisticLockException caught on second flush");
